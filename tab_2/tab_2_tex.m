%%%%%%%%%%%%%%%%%%%% tab_2  Fills table 2 for Latex export %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for Num_ind=1:16
   ...
   ntree=length(iCell);
   oNums{Num_ind}=strcat('$',num2str(ntree),'$');
end
...
for Pair_ind=1:16
   ...
   oPairs{Pair_ind}=strcat('$',num2str(nPair),'$');
end
...
for Naff_ind=1:16
   ...
   oNaff{Naff_ind}=strcat('$',num2str(round(nMean,2)),'±',num2str(round(nSE,2)),'\,(',num2str(round(nLMean,2)),',',num2str(round(nHMean,2)),')','$');
end
...
for Mbrprop_ind=1:16
   ...
   oNCompbranch{Mbrprop_ind}=strcat('$',num2str(round(NCompMean,2)),'±',num2str(round(NCompSE,2)),'\,(',num2str(round(NCompMeanL,2)),',',num2str(round(NCompMeanH,2)),')','$');
   ...
   oMubranch{Mbrprop_ind}=strcat('$',num2str(round(MuMean,2)),'±',num2str(round(MuSE,2)),'\,(',num2str(round(MuMeanL,2)),',',num2str(round(MuMeanH,2)),')','$');
end
...
for MAttenprop_ind=1:16
   ...
   oNCompAtten{MAttenprop_ind}=strcat('$',num2str(round(NCompMean,2)),'±',num2str(round(NCompSE,2)),'\,(',num2str(round(NCompMeanL,2)),',',num2str(round(NCompMeanH,2)),')','$');
   ...
   oMuAtten{MAttenprop_ind}=strcat(num2str(round(MuMean,2)),'±',num2str(round(MuSE,2)),'(',num2str(round(MuMeanL,2)),'±',num2str(round(MuSEL,2)),',',num2str(round(MuMeanH,2)),'±',num2str(round(MuSEH,2)),')'); 
    oMuAtten{MAttenprop_ind}=strcat('$',num2str(round(MuMean,2)),'±',num2str(round(MuSE,2)),'\,(',num2str(round(MuMeanL,2)),',',num2str(round(MuMeanH,2)),')','$'); 
end
...
writetable(T,'../panels/tab_2/table_2t.txt');
writetable(T,'../panels/tab_2/table_2t.csv');

save('../panels/tab_2/table_2t','T');